...
/**
 * Country Phone Validation & Normalization Module for Dashboard Web Forms
...
/**
 * Zod schema for optional phone in dashboard creation forms.
 * - Accepts empty string / undefined / null as valid (optional field)
 * - If provided, validates against general E.164 / country standards
 */
export const optionalPhoneSchema = z
  ...
  .refine(
    ...
    {
      message: "Please enter a valid phone number (between 7 and 15 digits)",
    },
  );
