...
const schema = z.object({
  stationName: z.string().min(1, "Channel name is required"),
  country: z.string().min(1, "Country is required"),
  partner: z.string().min(1, "Partner is required"),
  stationCode: z.string().min(1, "Channel code is required"),
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input placeholder="e.g. Capital Sports" {...register("stationName")} />
          ...
          <div>
            <label className="block text-xs font-semibold text-foreground mb-1.5">Channel Logo</label>
