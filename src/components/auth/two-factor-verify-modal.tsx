      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <input
            ...
            placeholder="000000"
            className="w-full text-center font-mono text-3xl tracking-[0.4em] font-bold px-4 py-3 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-[#02B2FF] focus:border-transparent bg-background"
            autoFocus
            disabled={isLoading}
          />
        </div>
