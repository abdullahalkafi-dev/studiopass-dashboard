...
export default function ChannelsContent() {
  ...
  const allRows = useMemo(
    () => stationsData.stations.filter((s) => s.category === "channels"),
    []
  );
  ...
  function toggleStatus(id: string) {
    ...
    toast.success(`Channel ${r?.status === "Active" ? "deactivated" : "activated"} successfully`);
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Manage channel accounts and configurations.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2.5">
          ...
          <Link
            href="/station-management/channels/create"
      ...
      <div className="grid grid-cols-4 gap-4">
        <KpiCard
          ...
          trend={{ val: "+0 this month vs last month", up: false }}
        />
        <KpiCard
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/40">
                ...
                <th className="px-5 py-3 text-left text-xs font-semibold text-muted-foreground uppercase tracking-wide">Channel Admin</th>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30" onClick={() => setViewing(null)}>
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="px-6 py-5 grid grid-cols-2 gap-4">
              ...
              <div>
                <div className="text-xs font-semibold text-muted-foreground uppercase tracking-wide mb-1">Channel Admin</div>
