  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-foreground">Customer Care Dashboard</h1>
        ...
        <Link
          href="/support"
          className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#02B2FF] text-white font-semibold text-sm shadow-md hover:bg-[#029BDC] transition-all shrink-0"
        >
          <Headphones size={16} />
          Go to Support Inbox
          <ArrowRight size={16} />
