...
export default function TvStationsContent() {
  ...
  const allRows = useMemo(
    () => stationsData.stations.filter((s) => s.category === "tv"),
    []
  );
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-start justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-0.5">
              Manage all tv stations across the platform.
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2.5">
          ...
          <Link
            href="/station-management/tv/create"
      ...
      <div className="grid grid-cols-4 gap-4">
        <KpiCard
          label="Total TV Stations"
          value={String(total)}
          icon={<Monitor size={16} className="text-[#02B2FF]" />}
          iconBg="bg-[#EFF8FF]"
          trend={{ val: "+2 this month vs last month", up: true }}
        />
        <KpiCard
        ...
        <KpiCard
          ...
          iconBg="bg-[#EFF8FF]"
          trend={{ val: "+1 vs last month", up: true }}
        />
      </div>
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm p-4">
        <div className="flex items-center gap-3">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Search tv station or admin..."
              value={search}
      ...
      <div className="bg-card rounded-xl border border-border shadow-sm overflow-hidden">
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-border">
          <span className="text-xs font-semibold text-muted-foreground">
            Showing {paged.length} of {filtered.length} stations
          </span>
                ...
                paged.map((row) => (
                  <tr key={row.id} className="border-b border-border last:border-0 hover:bg-muted/20 transition-colors">
                    <td className="px-5 py-3.5">
                      <div className="flex items-center gap-2.5">
                        <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center text-[#02B2FF]">
                          <Monitor size={14} />
                        </div>
                        <div>
