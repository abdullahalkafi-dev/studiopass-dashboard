...
function Sidebar({
  ...
  return (
    <aside className="w-full lg:w-60 shrink-0 bg-sidebar border-r border-border flex flex-col h-full overflow-y-auto">
      <div className="px-5 py-4 sm:py-5 border-b border-border flex items-center justify-between">
        ...
        {onClose && (
          <button
            onClick={onClose}
            className="lg:hidden p-1.5 rounded-lg text-muted-foreground hover:text-foreground hover:bg-muted transition-colors ml-2"
...
function AppHeader({
  ...
  return (
    <header className="h-14 bg-background border-b border-border flex items-center px-4 sm:px-6 gap-2.5 sm:gap-4 sticky top-0 z-20">
      <button
        type="button"
      ...
      <div className="flex-1 min-w-0">
        <h1 className="text-sm sm:text-base font-bold text-foreground truncate">{label}</h1>
        <p className="text-[10px] sm:text-[11px] text-muted-foreground leading-none truncate hidden sm:block">{crumb}</p>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3 shrink-0">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-1.5 sm:gap-2 hover:bg-muted rounded-lg p-1 sm:px-2 sm:py-1 transition-colors"
          >
            <Avatar
              src={stationLogoRaw}
              initials={initials}
              size="sm"
            />
            <div className="text-xs font-semibold text-foreground hidden sm:block">{ROLE_LABEL[role]}</div>
      ...
      <div className="flex h-screen overflow-hidden bg-background font-sans">
        ...
        {mobileNavOpen && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            />
            <div className="fixed inset-y-0 left-0 w-72 max-w-[85vw] bg-sidebar border-r border-border shadow-2xl flex flex-col z-50 animate-in slide-in-from-left duration-200">
              <Sidebar
                pathname={pathname}
                role={role}
        ...
        <div className="flex-1 flex flex-col overflow-hidden min-w-0">
          ...
          />
          <main className="flex-1 overflow-y-auto px-3 sm:px-4 md:px-6 py-4 sm:py-5 overflow-x-hidden">
            {children}
          </main>
        </div>
      </div>
